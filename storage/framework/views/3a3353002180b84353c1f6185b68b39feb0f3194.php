        ...
        <div class="d-flex px-2 justify-content-between align-items-center flex-wrap p-xl-0 py-lg-2">
            <ul class="menuhome justify-content-between">
                ...
                <?php if($primaryMenu->menus()->isNotEmpty()): ?>
                    <?php echo $__env->make('public.partials.primary_menu', ['type' => 1], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php endif; ?>
...
<div class="sidebar">
    ...
    <ul class="menu-sidebar">
        ...
        <?php if($primaryMenu->menus()->isNotEmpty()): ?>
            <?php echo $__env->make('public.partials.primary_menu', ['type' => 2], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
